...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    ...
    <input type="email" id="email" name="email" placeholder="Enter Valid Email" value="<?php echo $data['email']; ?>" oninput="actionOnInput('email', 'emailCount')"><span id="emailCount"></span>
    <span class="error" > <?php echo $errors["email"];?></span><br><br>
   
    <label for="pincode">Enter Pincode:</label>
    <input type="number" id="pincode" placeholder="Enter Valid Pincode" name="pincode" value="<?php echo $data['pincode']; ?>" oninput="actionOnInput('pincode', 'pincodeCount')"><span id="pincodeCount"></span>

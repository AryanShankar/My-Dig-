...
<body>
    ...
    // foreach ($arr1 as $person) //old arr1 ka syntax {
    //     // Extract PAN value
    //     $pan = $person['pan'];
    ...
    // Display the new array with people grouped by age
    ...
    // // Check if the age is found and display the result
    // if ($ageFound) {
    //     echo "The age $ageToCheck is available among the people.";
    // } else {
    //     echo "The age $ageToCheck is not available among the people.";
    ...
    // Assume the age you want to count
    $ageToCount = 21;
    ...
    if (isset($ageCounts[$ageToCount])) {
        // Print the number of records with the specific age
        echo "Number of records with age $ageToCount: " . $ageCounts[$ageToCount];
    } else {
        // Print message if the specific age does not exist
    ...
    // foreach ($person as $p) {
    //     if ($p['age'] === $ageToCount) {
    //         // If the age matches the age to count, increment the counter
    //         $numberOfRecords++;
    //     }
    // }
    ...
    // Define the details of the new person
    $newPerson = [
        'fname' => 'John',
        'lname' => 'Doe',
        'age' => 25,
        'pan' => 'JOHND1234A' // Add a unique PAN number for the new person
    ];
    ...
    $newPeople = [
        [
            ...
            'lname' => 'Watson',
            'age' => 30,
            'pan' => 'EMMAW1234B' // Add a unique PAN number for the new person
        ],
        [
            'fname' => 'Tom',
            'lname' => 'Holland',
            'age' => 26,
            'pan' => 'TOMH3210C' // Add a unique PAN number for the new person
        ]
    ];
